...
interface LoginComponentPropsInterface {
  onLogin: (username: string, password: string) => void;
}
const LoginComponent: React.FunctionComponent<LoginComponentPropsInterface> = ({
  onLogin,
}) => {
  ...
  const doLogin = (e: MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
